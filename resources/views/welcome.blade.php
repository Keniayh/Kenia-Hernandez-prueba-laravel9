...
<body style="background-color: rgba(182, 192, 201, 0.824)">
    <h1>CRUD</h1>
    @if (session('Correcto'))
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Registrar promoción</h1>
    ...
    <div class="p-5 table-responsive">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdropPromo">Añadir
            Promoción</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" data-bs-toggle="modal"
                                ...
                                <form action="{{ route('promocion.destroy', $item->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro que deseas eliminar esta promoción?');">
                                        ...
                                        <form action="{{ route('promocion.update', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                    onclick="return confirm('¿Estás seguro de eliminar esta promoción?');">Modificar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
